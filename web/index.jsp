...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#loginOut').click(function() {
			$.messager.confirm('系统提示', '您确定要退出本次登录是不?', function(r) {
...
疯狂秀才 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
...
<div region="west" split="true" title="导航菜单" style="width: 180px;"
	id="west">
<div class="easyui-accordion" fit="true" border="false"><!--  导航内容 -->
...
<div region="south" border="false"
	...
	id="btnEp" class="easyui-linkbutton" icon="icon-ok"
