...
import com.jckj.webbasic.service.PermissionGroupManager;
...
public class PermissionGroupController extends BaseRestSpringController<PermissionGroup,java.lang.Integer>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private PermissionGroupManager permissionGroupManager;
	
	private final String LIST_ACTION = "redirect:/permissiongroup";
	...
	public String update(ModelMap model,@PathVariable java.lang.Integer id,@Valid PermissionGroup permissionGroup,BindingResult errors,HttpServletRequest request,HttpServletResponse response) throws Exception {
		if(errors.hasErrors()) {
			return "/permissiongroup/edit";
		}
